...
| 38 | `tests/test_slash.lua` | 168 | `NS.COMMANDS` verb table, dispatch, unknown-verb handling, the `/at version` verb, `OpenOptionsPanel` `[Cfg]` refusal logging, `SetByPath` `[Set]` logging (`debug-logging-§10`). |
