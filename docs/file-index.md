...
| 18 | `Options/Border.lua` | 91 | One section "Border" laid out as 2×2: `border` (LSM border style) / `borderSize`; `borderColor` / `useClassColorBorder`. LSM dropdown calls `AddonTable.Helpers.LSMValues("border")`. |
