...
the shared mock answers `GetHeight` with 0 for every frame, and that flips in the kit (not at kit 16,
which shipped Ace-fake fixes instead; revision 17 at the earliest), not here. **So
