...
--      repo where half the call sites say "color" is a repo that one `grep -r color` no longer
...
--
-- "canceled" is absent from the list on purpose: it never had a live site of its own here --
