-- AbsorbTracker: Panel/About.lua
--
-- Top-level "Ka0s Absorb Tracker" page builder. Logo, addon Notes
-- one-liner, "Slash Commands" heading, and a row per AddonTable.SlashCommands
-- entry so the about page stays in lockstep with /at help. Decorates
-- AddonTable.Helpers.BuildMainContent; OptionsPanel.lua's registerMain
