...
![Tests](https://img.shields.io/badge/Tests-635%2F635_passing-green)
...
name, so there is something to grab even with no shield up — and an enabled Target or Focus bar
