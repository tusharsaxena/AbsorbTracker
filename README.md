...
![Tests](https://img.shields.io/badge/Tests-511%2F511_passing-green)
...
own class colors). While a toggle is on, its color picker greys out; turn the toggle off to pick a
color by hand again.
